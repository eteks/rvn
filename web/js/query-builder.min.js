...
! function (e, t) {
	...
	"use strict";
	$.extendext = function () {
		var e, t, r, n, i, o, l = arguments[0] || {},
			s = 1,
			a = arguments.length,
			u = !1,
			p = "default";
		for ("boolean" == typeof l && (u = l, l = arguments[s++] || {}), "string" == typeof l && ("concat" !== (p = l.toLowerCase()) && "replace" !== p && "extend" !== p && (p = "default"), l = arguments[s++] || {}), "object" == typeof l || $.isFunction(l) || (l = {}), s === a && (l = this, s--); s < a; s++)
			if (null !== (e = arguments[s]))
				if ($.isArray(e) && "default" !== p) switch (o = l && $.isArray(l) ? l : [], p) {
					case "concat":
					...
					for (t in e) r = l[t], l !== (n = e[t]) && (u && n && ($.isPlainObject(n) || (i = $.isArray(n))) ? (i ? (i = !1, o = r && $.isArray(r) ? r : []) : o = r && $.isPlainObject(r) ? r : {}, l[t] = $.extendext(u, p, o, n)) : void 0 !== n && (l[t] = n));
		return l
	}
}),
function () {
	...
	u.template = function (e, t, r) {
		var n, i, o = (t = t || u.templateSettings).append ? p.append : p.split,
			l = 0,
...
function (e, t) {
	...
	$.extend(c.prototype, {
		...
		var o = this.nextGroupId(),
			l = $(this.getGroupTemplate(o, i)),
			s = e.addGroup(l);
		...
		var n = this.nextRuleId(),
			i = $(this.getRuleTemplate(n)),
			o = e.addRule(i);
		...
		if (e.filter) {
			var r = this.getOperators(e.filter),
				n = $(this.getRuleOperatorSelect(e, r));
		...
		! function r(e, n) {
			null !== n && (void 0 === e.condition ? e.condition = o.settings.default_condition : -1 == o.settings.conditions.indexOf(e.condition) && (h.error(!i.allow_invalid, "UndefinedCondition", 'Invalid condition "{0}"', e.condition), e.condition = o.settings.default_condition), n.condition = e.condition, e.rules.forEach(function (e) {
				var t;
				if (void 0 !== e.rules)
					if (-1 !== o.settings.allow_groups && o.settings.allow_groups < n.level) h.error(!i.allow_invalid, "RulesParse", "No more than {0} groups are allowed", o.settings.allow_groups), o.reset();
					else {
		...
		if ("-1" == e) return null;
		for (var r = 0, n = this.filters.length; r < n; r++)
		...
		if ("-1" == e) return null;
		for (var r = 0, n = this.operators.length; r < n; r++)
		...
		var t = e.filter,
			r = e.operator,
			n = [];
		if (t.valueGetter) n = t.valueGetter.call(this, e);
		else {
		...
		var r = e.filter,
			n = e.filter.validation || {},
			i = e.id + "_value_" + t,
			o = r.vertical ? " class=block" : "",
			l = "";
		if ("function" == typeof r.input) l = r.input.call(this, e, i);
		else switch (r.input) {
			case "radio":
			case "checkbox":
	...
	a.prototype = Object.create(i.prototype), a.prototype.constructor = a, h.defineModelProperties(a, ["condition"]), a.prototype.empty = function () {
		...
		for (var i = e ? this.rules.length - 1 : 0, o = e ? 0 : this.rules.length - 1, l = e ? -1 : 1, s = !1;
			(e ? o <= i : i <= o) && (this.rules[i] instanceof a ? r && (s = !1 === r.call(n, this.rules[i])) : t && (s = !1 === t.call(n, this.rules[i])), !s); i += l);
		return !s
	...
	return l.prototype = Object.create(i.prototype), l.prototype.constructor = l, h.defineModelProperties(l, ["filter", "operator", "value"]), l.prototype.isRoot = function () {
		...
		"inline" === i.mode ? this.on("afterUpdateRuleFilter afterUpdateRuleOperator", function (e, t) {
			var r = t.$el.find("p.filter-description"),
				n = e.builder.getFilterDescription(t.filter, t);
		...
		getMongo: function (e) {
			...
			return function i(e) {
				...
				e.rules.forEach(function (e) {
					if (e.rules && 0 < e.rules.length) o.push(i(e));
					else {
		...
		sqlRuleStatement: {
			...
			numbered: function (t, r) {
				(!r || 1 < r.length) && (r = "$");
				var n = new RegExp("^\\" + r + "[0-9]+$"),
					i = new RegExp("\\" + r + "([0-9]+)", "g");
				return {
					parse: function (e) {
			...
			named: function (t, r) {
				(!r || 1 < r.length) && (r = ":");
				var n = new RegExp("^\\" + r),
					i = new RegExp("\\" + r + "(" + Object.keys(t).join("|") + ")", "g");
				return {
					parse: function (e) {
				...
				r = function l(e) {
					...
					e.rules.forEach(function (r) {
						if (r.rules && 0 < r.rules.length) s.push("(" + u + l(r) + u + ")" + u);
							...
							var n = d.settings.sqlOperators[r.operator],
